...
--
-- Host: localhost:3306
-- Generation Time: Mar 13, 2025 at 12:08 PM
...
--
-- Database: `bilalturabi_pharma_chatbot`
--
...
('bilal@gmail.com', '$2y$10$jsQ/t4v1nUr6wl8n2bpoTecNg4GW9xo6pr0x3miX/fn.lG6Sh3DIy', 'Muhammad Bilal', '3122708694'),
...
CREATE TABLE `orders` (
  ...
  `phone_number` varchar(10) NOT NULL,
  `deal_code` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `order_id` int(5) NOT NULL,
  `customer_id` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
INSERT INTO `orders` (`fname`, `lname`, `address`, `state_country`, `postalcode`, `email`, `phone_number`, `deal_code`, `order_id`, `customer_id`, `total`, `status`) VALUES
('Rutali', 'Bandivadekar', '7575 Frankford Road', 'Texas', '75252', 'rutalib@gmail.com', '8787878589', 'smartdeal', 14, 'rutalib@gmail.com', '$58', 'In Transit'),
('Simran', 'Arora', '7575 Frankford Road', 'Texas', '75252', 'simran@gmail.com', '7878744555', 'smartdeal', 24, 'rutalib@gmail.com', '$58', 'In Transit'),
('Rutali', 'Bandivadekar', '7575 Frankford Road', 'Texas', '75252', 'rutali@gmail.com', '5896547854', 'smartdeal', 25, 'rutali@gmail.com', '$26', 'In Transit'),
('Yash', 'Modi', 'Cambell', 'Texas', '752452', 'yash@gmail.com', '8756896541', 'bigsaving', 28, 'rutali@gmail.com', '$2.75', 'In Transit'),
('Simran', 'Arora', '7575 Frankford Road', 'United States', '752521', 'simran@gmail.com', '8765986587', 'smartdeal', 34, 'rutali@gmail.com', '$11.99', 'In Transit'),
('Sagar', 'Kawthankar', 'Mccallum', 'United States', '578874', 'sagar@gmail.com', '8989875645', '', 47, 'rutali@gmail.com', '$32.99', 'Completed'),
('Rutali', 'Bandivadekar', 'University of Texas at Dallas', 'Texas', '752520', 'rutali@gmail.com', '9898876598', '', 48, 'rutali@gmail.com', '$34.75', 'Completed'),
('Yash', 'Modi', 'Campbell', 'United States', '985895', 'yash@gmail.com', '8765549854', 'smartdeal', 49, 'rutali@gmail.com', '$12', 'Completed'),
('Rutali', 'Bandivadekar', '7575 Frankford Road', 'Texas', '752521', 'rutali@gmail.com', '9858965415', 'bigsaving', 50, 'rutali@gmail.com', '$22.98', 'Completed'),
('Rutali', 'Bandivadekar', '7575 Frankford Road', 'Texas', '075252', 'rutali@gmail.com', '8989857450', 'bigsaving', 51, 'rutali@gmail.com', '$6.2', 'Completed'),
('Rutali', 'Bandivadekar', '7575 Frankford Road', 'Texas', '752520', 'rutali@gmail.com', '9865896541', 'smartdeal', 52, 'rutali@gmail.com', '$8', 'Completed'),
('Sagar', 'Kawthankar', 'Chatham Courts', 'Texas', '012457', 'sagar@gmail.com', '9856859564', 'smartdeal', 53, 'rutali@gmail.com', '$16.99', 'Completed'),
('Yash', 'Modi', 'Ashwood', 'Texas', '024589', 'yash@gmail.com', '9898989898', 'bigsaving', 54, 'yash@yahoo.in', '$6.75', 'Completed');
...
(1, 'Crocin', 10, 'Crocin is a carotenoid chemical compound that is found in the flowers crocus and gardenia. Crocin is the chemical primarily responsible for the color of saffron. Chemically, crocin is the diester formed from the disaccharide gentiobiose and the dicarboxylic acid crocetin.', 'crocin.jpg', 290, '', 1, '1'),
