...
<html lang="en">
  ...
  <div class="site-wrap">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="index.php" class="js-logo-clone">Turabi Pharmacy</a>
              </div>
            </div>
                ...
                <ul>
                  <?php
                    ...
                    if(isset($_SESSION['user_name'])){
                      echo '<li><a href="profile.php">Howdy '.$_SESSION['user_name'].'<i class="fas fa-user"></i></li>';
                    }else{
                      echo '<li><a href="signup.php"><span class="icon glyphicon glyphicon-user"></span></a></li>';
        ...
        <div class="row">
          <div class="col-md-5">
            <h1 class="mb-2">Purchase Prescription Drugs Online</h1>
              <p class="mb-4">Turabi Pharmacy is completely committed to providing quality when it comes to your prescription medications. </p>
              <p>
      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-12 col-lg-5 justify-content-center">
            <p>Turabi Pharmacy pharmacists are unique because they understand the importance of personalized care. On top of receiving a comprehensive education needed to meet state licensing requirements, all our pharmacists are professionally certified to provide immunizations. What sets our pharmacists apart from the rest are their daily interactions with you, our customers. Because at Turabi Pharmacy, we care.</p>
		  ...
		  <div class="row">
			<div class="col-lg-6">
			  <div class="features-icons-item mx-auto mb-5">
				...
				<h3>Free Shipping</h3>
				<p>Turabi Pharmacy Offers Free Shipping with No Minimum</p>
			  </div>
			</div>
			<div class="col-lg-6">
			  <div class="features-icons-item mx-auto mb-5">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
			...
			<div class="panel">
			  <p>You will need to contact your local Turabi Pharmacy pharmacy to see if your prescription is ready. My Pharmacy members can also see if their prescription is ready by logging in to their account and/or signing up to receive prescription reminders via email or text message.</p>
			</div>
			...
			<button class="accordion">Does Turabi Pharmacy carry a particular product?</button>
			<div class="panel">
			  <p>You will need to contact your local Turabi Pharmacy store for inventory information. If the product is not in stock, the pharmacist may be able to place a special order.</p>
			</div>
    ...
    <df-messenger
      intent="WELCOME"
      chat-title="VU_Pharmacy_ChatBot"
      agent-id="ccb93f79-11c5-4864-9672-9c3330ee9860"
      language-code="en"
    ></df-messenger>
    <?php }?>
  </body>
